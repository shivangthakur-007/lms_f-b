...
import { getUserData, updatedProfile } from "../../Redux/Slice/AuthSlice";
...
function EditProfile() {
  ...
  async function onFormSubmit(e) {
    ...
    if (data.fullName.length < 5) {
      toast.error("Name cannont of less than 5 characters.");
      return;
    }
    ...
    await dispatch(updatedProfile([data.userId, formData]));
